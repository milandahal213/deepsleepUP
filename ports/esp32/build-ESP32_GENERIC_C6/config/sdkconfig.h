...
#define CONFIG_PARTITION_TABLE_CUSTOM_FILENAME "partitions-4MiB.csv"
#define CONFIG_PARTITION_TABLE_FILENAME "partitions-4MiB.csv"
...
#define CONFIG_ULP_SHARED_MEM 0x8
